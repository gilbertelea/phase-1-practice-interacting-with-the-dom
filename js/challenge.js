...
//append p into ul tag with class "likes"
document.querySelector('.likes').appendChild(Li)
//create a and target his value       
let a = document.getElementById("counter")
// console.log(a.textContent + `  has been liked <span>" +1 + "</span> times`);
let b = a.textContent + " has been liked 1 time"
Li.textContent = b
...
form.addEventListener('submit', e =>{
    e.preventDefault()
    Handle(e.target.comment_input.value)
    form.reset()
})
